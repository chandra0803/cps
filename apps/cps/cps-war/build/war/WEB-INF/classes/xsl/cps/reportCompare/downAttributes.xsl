	...
	<TD>
          <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            ...
            <select name="attribute" multiple="true" size="6">
              <option value="0">D-H Customer Code (dhcustcode) [Common]</option>
              <option value="1">D-H Customer Descriptions (dhcustdescr) [File 1]</option>
              <option value="2">D-H Customer Part Number (dhcpn) [File 1]</option>
              <option value="3">D-H Divisional Buyer Code (dhbuyercode) [Common]</option>
              <option value="4">D-H DPN Descriptions (dhdpndescr) [File 2]</option>
              <option value="5">D-H xxx [Common]</option>
              <option value="6">D-H xxx [Common]</option>
              <option value="7">D-H xxx [Common]</option>
              <option value="8">D-H xxx [Common]</option>
              <option value="9">D-H xxx [Common]</option>
              <option value="10">D-H xxx [Common]</option>
              <option value="11">D-H xxx [Common]</option>
              <option value="12">D-H xxx [Common]</option>
              <option value="13">D-H xxx [Common]</option>
            </select>
              </TD>
            </TR>
            <TR>
