...
$Log: topAttributes.xsl,v $
Revision 1.1  2004/10/08 20:02:09  vz86k2
check in
...
<xsl:template match="View">
  ...
  <TABLE cellSpacing="0" cellPadding="0" height="100%" width="100%" border="0" class="tbllb">
    <thead>
      <TR>
	<TD style="HEIGHT: 22px" colSpan="2">Select Horizontal Report Attributes</TD>
      </TR>
    </thead>
    <tbody>
      <TR>
	<TD>
          <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
            ...
            <select name="attribute" multiple="true" size="6">
              <option value="0">Year (year) [Common]</option>
              <option value="1">Model Year (myear) [Common]</option>
            </select>
              </TD>
            </TR>
            <TR>
