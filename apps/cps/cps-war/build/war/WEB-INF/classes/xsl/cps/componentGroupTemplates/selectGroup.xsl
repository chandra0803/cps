...
<!--
$Revision: 1.2 $
$Log: selectGroup.xsl,v $
Revision 1.2  2004/10/25 17:41:43  zz0qx3
updates

Revision 1.1  2004/10/22 20:04:55  zz0qx3
combined manage and create

Revision 1.1  2004/10/19 18:35:43  zz0qx3
added edit template
...
<xsl:template match="View">
  ...
  <TABLE id="Table1" cellSpacing="0" cellPadding="0" height="100%" width="100%" border="0" class="tbllb">
    <thead>
      <TR>
	<TD style="HEIGHT: 22px" colSpan="5">Select Component Group Template</TD>
      </TR>
    </thead>
    <tbody>
      <TR>
	<TD style="WIDTH: 60px" vAlign="top" align="right">Template Name:&#160;</TD>
	<TD vAlign="top" colspan="2"><input name="filename" type="text" style="width:232px;" value="{$currentName}"/></TD>
        <TD>&#160;</TD>
      </TR>
      <TR>
	...
	<TD style="HEIGHT: 22px" colSpan="5"></TD>
      ...
      <TR>
        <TD style="WIDTH: 60px" vAlign="top" align="right">Create New Template:&#160;</TD>
        <TD vAlign="middle"><a class="button" href="javascript:go()">
        <font class="v8w">&#160;CREATE NEW&#160;</font></a>
        </TD>
