...
<!--
	<TD style="WIDTH: 60px; HEIGHT: 27px" vAlign="top" align="right">File Type:&#160;</TD>
	<TD style="HEIGHT: 27px" vAlign="top">

          <select name="fileType" size="1" style="height:27px;width:120px;">
	  ...
	  <div id="d2" style=" OVERFLOW:visible; WIDTH:840px">
		...
		<td style="color:White;background-color:LightGrey;font-weight:bold;">
		  ...
		  <span class="v7bbold" style="width:250px;VERTICAL-ALIGN: top">Comment</span>
              ...
              <xsl:apply-templates select="SelectFileResultSet/SelectFile">
                <xsl:with-param name="imgBaseUrl" select="$imgBaseUrl"/>
              </xsl:apply-templates>  
  	    </table>
	  </div>
